...
public class RegisterDriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.layoutContent).setOnTouchListener(new OnSwipeTouchListener(RegisterDriverActivity.this) {
            ...
            public void onResponse(Call<QueryResult<AccountDetails>> call, Response<QueryResult<AccountDetails>> response) {
                if (response.code() == 400) {
                    ...
                    try {
                        ...
                        Toast.makeText(RegisterDriverActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
                    }
                    ...
                    if(errorResponseValidation.Errors != null) {
                        ...
                        Toast.makeText(RegisterDriverActivity.this, errors, Toast.LENGTH_LONG).show();
                    } else {
                        //Jeżeli nie błędy walidacji to..
                        errorResponseAuthorization = gson.fromJson(responseJson, OperationError.class);

                        Toast.makeText(RegisterDriverActivity.this, errorResponseAuthorization.ErrorDetails.Message, Toast.LENGTH_LONG).show();

                        if (errorResponseAuthorization.ErrorDetails.Code == "500") {
                            //jeżeli błąd Bazy danych
                            Toast.makeText(RegisterDriverActivity.this, "Wysyłam raport", Toast.LENGTH_LONG).show();
                        } else {
                    ...
                    Toast.makeText(RegisterDriverActivity.this, "Brak połączenia z Internetem", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<QueryResult<AccountDetails>> call, Throwable t) {
                Toast.makeText(RegisterDriverActivity.this, "Coś poszło nie tak: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
                                ...
                                if (response.code() == 400) {
                                    ...
                                    if (result != null) {
                                        ...
                                        HintSpinner<String> hintSpinnerCities = new HintSpinner<>(
                                                ...
                                                // your list data
                                                new HintAdapter<String>(RegisterDriverActivity.this, "Miasto", spinnerCitiesList),
                                        ...
                                        HintSpinner<String> hintSpinnerDays = new HintSpinner<>(
                                                ...
                                                // Default layout - You don't need to pass in any layout id, just your hint text and
                                                // your list data
                                                new HintAdapter<String>(RegisterDriverActivity.this, "Dzień", spinnerDaysList),
                                                new HintSpinner.Callback<String>() {
                                                    @Override
                                                    public void onItemSelected(int position, String itemAtPosition) {
                                                    }
...
//        //end fill lists
    ...
    public void driverRegisterAddCity(View view){
        ...
        try {
            ...
            Toast.makeText(RegisterDriverActivity.this, "Wybierz prawidłowo miasto", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void driverRegisterAddDay(View view){
        ...
        try {
            ...
            Toast.makeText(RegisterDriverActivity.this, "Wybierz prawidłowo dzień i godziny", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void becomeDriver(View view) {
        ...
        try {
            ...
            call.enqueue(new Callback<QueryResult<Object>>() {
                ...
                public void onResponse(Call<QueryResult<Object>> call, Response<QueryResult<Object>> response) {
                    if (response.code() == 400) {
                        ...
                        if (errorResponseValidation.Errors != null) {
                            ...
                            for (OperationError error : errorResponseValidation.Errors) {
                                switch (error.ErrorDetails.Field) {
                                    ...
                                    default: {
                                        Toast.makeText(RegisterDriverActivity.this, error.ErrorDetails.Message, Toast.LENGTH_LONG).show();
                                    }
                                }
                            }
                        } else {
                        ...
                        if (result != null) {
                            Toast.makeText(RegisterDriverActivity.this, result.Message, Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(RegisterDriverActivity.this, PurchasesActivity.class);
                            startActivity(intent);
                        }
                    } else {
                        //jeżeli brak internetu
            ...
            Toast.makeText(RegisterDriverActivity.this, "Uzupełnij poprawnie dane", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void menuOrders(View view) {
        Intent intent = new Intent(RegisterDriverActivity.this, OrdersActivity.class);
        startActivity(intent);
    }

    public void menuSettings(View view) {
        Intent intent = new Intent(RegisterDriverActivity.this, SettingsActivity.class);
        startActivity(intent);
    }

    public void menuBacomeDriver(View view) {
        Intent intent = new Intent(RegisterDriverActivity.this, RegisterDriverActivity.class);
        startActivity(intent);
    }
    ...
    public void menuDriverSettings(View view) {
        Intent intent = new Intent(RegisterDriverActivity.this, DriverSettingsActivity.class);
        startActivity(intent);
    }
